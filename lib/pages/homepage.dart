    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          NavButton(title: 'Contact',ontap: () => scrollTo(homeKey),),
        ],
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            /// PROJECTS
            Column(key: projectsKey,
              children: [
                const SectionTitle(title: 'Projects'),Wrap(
                  spacing: 20,
                  runSpacing: 20,
                  children: const [
                    ProjectCard(
                    ...
                    ProjectCard(title: 'PDF Annotator', desc: 'Draw & save PDFs'),
                    ProjectCard(
